...
const localStorageAvailable = () => {
  ...
  try {
    window__default["default"].localStorage.setItem(key, '.');
    window__default["default"].localStorage.removeItem(key);
    return true;
  } catch (e) {
    return false;
  }
...
const onPlayerReady = (player, options) => {
  ...
  const data = JSON.parse(window__default["default"].localStorage.getItem(options.key)) || {};
  ...
  if (options.playbackRate) {
    player.on('ratechange', () => {
      ...
      window__default["default"].localStorage.setItem(options.key, JSON.stringify(data));
    });
  }
